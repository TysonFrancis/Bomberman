...
Entity(tex,pods),value(input), x(inX), y(inY)
	...
	setPosition(x, y);
	if (value <= 1000)
		Entity::sprite.setTextureRect(sf::IntRect(sf::Vector2i(116, 8 * log2(value / 100) + 338), sf::Vector2i(16, 6)));
	else Entity::sprite.setTextureRect(sf::IntRect(sf::Vector2i(116, 8 * log2(value / 1000) + 338), sf::Vector2i(16, 6)));
	}
