	...
	enemy3(animations.getEntities(), 6)
{
    ...
    // ********** TEMPORARY **********
	enemy1.getSprite().setTextureRect(sf::IntRect({ 0, 240 }, { 16, 16 }));
	enemy1.getSprite().setScale({ 4.f, 4.f });
    enemy1.getSprite().setPosition({ 320.f, 256.f });

    enemy2.getSprite().setTextureRect(sf::IntRect({ 0, 256 }, { 16, 16 }));
    enemy2.getSprite().setScale({ 4.f, 4.f });
    enemy2.getSprite().setPosition({ 576.f, 512.f });

    enemy3.getSprite().setTextureRect(sf::IntRect({ 0, 320 }, { 16, 16 }));
    enemy3.getSprite().setScale({ 4.f, 4.f });
    enemy3.getSprite().setPosition({ 832.f, 320.f });
}
